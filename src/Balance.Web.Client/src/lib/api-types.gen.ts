...
export interface paths {
    ...
    "/api/dashboard/spending-by-category": {
        ...
        get: operations["GetDashboardSpendingByCategory"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        JsonPatchDocumentOfUpdateAccountInput: ({
            ...
            op: "add" | "replace" | "test";
            /** @enum {string} */
            path: "/name" | "/code" | "/accountType" | "/currencyCode" | "/isPostable" | "/isLiquid" | "/horizon" | "/parentAccountId" | "/iconName";
            value: unknown;
        } | {
            /** @enum {string} */
            op: "move" | "copy";
        ...
        SpendingByCategoryOutput: {
            slices: components["schemas"]["SpendingCategorySlice"][];
            /** Format: int64 */
